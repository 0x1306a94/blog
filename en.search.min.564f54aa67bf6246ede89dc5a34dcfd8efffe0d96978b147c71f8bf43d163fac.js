...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8a7e20b3e0be0d7d187347368c7b64268564c9da61336426a87347bfc2af6756.js',function(){input.required=false;search();});}
